...
def Proposal_layer(preprocessed_inputs, box_encodings, class_prediction):
    from platformx.plat_tensorflow.tools.processor.test.error_tf_custom_layer import TensorflowProposal
...
def ROIPooling_layer(rpn_box_predictor_features, proposals):
    from platformx.plat_tensorflow.tools.processor.test.error_tf_custom_layer import TensorflowROIPooling
    inputs = [
